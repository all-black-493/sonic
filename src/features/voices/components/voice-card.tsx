...
export type VoiceItem =
    InferRouterOutputs<typeof router>["voicesRouter"]["getAll"]["custom"][number]
...
export function VoiceCard({ voice }: VoiceCardProps) {
    ...
    const deleteMutation = useMutation(
        orpc.voicesRouter.deleteVoice.mutationOptions({
            onSuccess: () => {
                toast.success("Voice deleted successfully");
                queryClient.invalidateQueries({
                    queryKey: orpc.voicesRouter.getAll.queryKey({ input: {} }),
                });
            },
            onError: (error) => {
