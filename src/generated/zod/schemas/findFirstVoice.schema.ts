...
export const VoiceFindFirstSelectSchema: z.ZodType<Prisma.VoiceSelect> = z.object({
...
export const VoiceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orgId: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const VoiceFindFirstSchema: z.ZodType<Prisma.VoiceFindFirstArgs> = z.object({ select: VoiceFindFirstSelectSchema.optional(), include: z.lazy(() => VoiceIncludeObjectSchema.optional()), orderBy: z.union([VoiceOrderByWithRelationInputObjectSchema, VoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: VoiceWhereInputObjectSchema.optional(), cursor: VoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VoiceScalarFieldEnumSchema, VoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VoiceFindFirstArgs>;

export const VoiceFindFirstZodSchema = z.object({ select: VoiceFindFirstSelectSchema.optional(), include: z.lazy(() => VoiceIncludeObjectSchema.optional()), orderBy: z.union([VoiceOrderByWithRelationInputObjectSchema, VoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: VoiceWhereInputObjectSchema.optional(), cursor: VoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VoiceScalarFieldEnumSchema, VoiceScalarFieldEnumSchema.array()]).optional() }).strict();